...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] loader =
                new String[]{"Crossword Grid", "Concentric Cirlces", "HeartBeat", "Heart Shape"};

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, android.R.id.text1, loader);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 1:
                        ...
                        concentricCirclesDialog.show(getSupportFragmentManager(),
                    ...
                    default:
                        Toast.makeText(getApplicationContext(), "wrong choice",
