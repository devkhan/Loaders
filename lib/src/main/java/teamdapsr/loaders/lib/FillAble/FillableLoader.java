 ...
 */
package teamdapsr.loaders.lib.FillAble;
...
public class FillableLoader extends View {
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    float phase = Utils.constrain(0, 1, elapsedTime * 1f / strokeDrawingDuration);
    ...
    if (isStrokeTotallyDrawn(elapsedTime)) {
      ...
      float fillPhase =
          Utils.constrain(0, 1, (elapsedTime - strokeDrawingDuration) * 1f / fillDuration);
